        ...
        <div className="flex items-center justify-between h-20">
          ...
          <div className="flex items-center gap-10">
            ...
            <NavLink to="/" onClick={closeMenu} className="flex items-center gap-3 group shrink-0">
              ...
              <span className="text-xl font-extrabold bg-clip-text text-transparent bg-linear-to-r from-blue-700 to-indigo-600">
                NexusApp
              </span>
            </NavLink>

            {/* 2. Desktop Navigation Links (Positioned on the Left) */}
          ...
          {/* Right Side: Mobile Menu Button (Only visible on small screens) */}
